export const SPRITE_MANIFEST = Object.freeze({
  ...
  room: 'room.png',
  kitchen_room: 'kitchen_room.webp',
  kitchen_island: 'kitchen_island.png',
  kitchen_fridge: 'kitchen_fridge.png',
  kitchen_bin: 'kitchen_bin.png',
  rug: 'rug.png',
  window: 'window.png',
  tv: 'tv.png',
  robot: 'robot.png',
...
// Recorded effects generated by scripts/gen_sfx.py (ElevenLabs) — mp3s in
// public/assets/sfx/. Loaded by core/Sfx.js; synth fallbacks cover absences.
