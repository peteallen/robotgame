...
// spins, happy beeps, bouncing, fireworks, and the big all-clean win party.
...
export const WinParty = {
  ...
  update(g, dt) {
    ...
    if (st.t > 4.0 && Math.abs(r.spinExtra) < 0.15) {
      r.spinExtra = 0;
      g.sound.happyBeeps(5);
      // job done: head home the normal way and stay parked until tapped
      r.dockAfterAction = true;
      this.finished = true;
    }
  },
  end(g) {
